...
All Phase 1 features adapted to Spring Boot with unit tests for each service method.
...
Note: Kafka was added to this project not because it was required for a monolithic architecture, but as a learning step. It was integrated intentionally to gain hands-on experience with Kafka and to prepare for future microservices-based projects, even though it is not typically necessary in a single-service system.
