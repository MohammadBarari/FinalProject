...
public class GetSubHandlerForCustomerServiceTest {
    @Mock
    ...
    @InjectMocks
    private GetSubHandlerForCustomerService getSubHandlerForCustomerService;
    ...
    void testGiveOfferToOrder_offerPriceLessThanOrderPrice() {
        ...
        assertThrows(OfferPriceIsLessThanOrderPrice.class, () -> getSubHandlerForCustomerService.GiveOfferToOrder(offerDto));
    }
    ...
    void testSetOrderStateToStart_success() throws Exception {
        ...
        getSubHandlerForCustomerService.setOrderStateToStart(orderId, OrderState.UNDER_REACHING_EMPLOYEE);
    ...
    void testSetOrderStateToStart_orderNotFound() {
        ...
        assertThrows(NotFoundOrder.class, () -> getSubHandlerForCustomerService.setOrderStateToStart(orderId, OrderState.UNDER_REACHING_EMPLOYEE));
    }
}
